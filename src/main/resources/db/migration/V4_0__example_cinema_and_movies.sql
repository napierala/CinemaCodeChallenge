...
INSERT INTO movie_showing (cinema_id, movie_id, date_time, room) values ((select id from cinema where code = 'FIRST'), (select id from movie where code = 'F&F1'), '2021-12-01 12:30:00.00', '1A');
INSERT INTO movie_showing (cinema_id, movie_id, date_time, room) values ((select id from cinema where code = 'FIRST'), (select id from movie where code = 'F&F1'), '2021-12-02 12:30:00.00', '2A');